...
print("2. styles.css - Complete styling with colorful design")
print("3. script.js - Interactive features and animations")
print("\nFeatures included:")
print("✓ Modern colorful gradient backgrounds")
print("✓ Smooth animations and hover effects")
print("✓ Mobile responsive design")
print("✓ Floating cards with printing themes")
print("✓ WhatsApp contact form integration")
print("✓ Clickable phone numbers")
print("✓ One-click GPay number copy")
print("✓ Smooth scrolling navigation")
print("✓ Professional pricing tables")
print("✓ Google Maps integration")
print("\nTo use: Simply open index.html in a web browser!")
